...
void VulkanBase::InitVulkan()
{
	...
	m_ImageManager.CreateTextureImage(device, m_DeviceManager.GetPhysicalDevice(),m_CommandPool.GetCommandPool(),
		m_DeviceManager.GetGraphicsQueue(), TEXTURE_MODEL_PATH, NORMAL_MAP_PATH, SPECULAR_MAP_PATH,ROUGHNESS_MAP_PATH); 
	...
	m_ImageManager.CreateRoughnessMapSampler(device, m_DeviceManager.GetPhysicalDevice());
