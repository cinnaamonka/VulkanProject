...
//#include <memory>
//
//VkDescriptorSetLayout GraphicsPipeline3D::m_DescriptorSetLayout = nullptr;
//
//void GraphicsPipeline3D::CreateGraphicsPipeline(const VkDevice& device, GP2Shader3D& shader,
//	const RenderPass& renderPass, const VulkanContext& context)
//{
...
//
//	m_UBOPool =
//		std::make_unique<DAEDescriptorPool<ViewProjection>>(context.device, 1);
...
//}
//
//void GraphicsPipeline3D::CreateDiscriptiveSetLayout(const VkDescriptorSetLayoutBinding& layoutBinding,
