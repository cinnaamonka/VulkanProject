...
void SwapChain::CreateSwapChain(const VkSurfaceKHR& surface, GLFWwindow* window,
	const QueueFamilyIndices& queueFamilyIndexes, const VkDevice& device, const VkPhysicalDevice& physicalDevice)
{
	...
	QueueFamilyIndices indices = queueFamilyIndexes;
...
void SwapChain::CreateImageViews(const VkDevice& device,ImageManager& imageManager)
{
