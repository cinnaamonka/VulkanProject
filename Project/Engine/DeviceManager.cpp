...
void DeviceManager::PickPhysicalDevice(const VkInstance& instance, const VkSurfaceKHR& surface)
{
...
bool DeviceManager::IsDeviceSuitable(const VkPhysicalDevice& physicalDevice, const VkSurfaceKHR& surface)
{
